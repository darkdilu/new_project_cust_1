...
Command: npx gltfjsx@6.4.1 new_tshirt10.glb 
*/

import React from 'react'
import { Decal, useGLTF, useTexture } from '@react-three/drei'
import goku from './one.png'
import { useControls } from 'leva'

export default function Model(props) {
  const texture = useTexture(goku)
  const { z,x } = useControls({
   
    z: { value: -1.7, min: -2.15, max: -1.2, step: 0.01 },

  })
  const { nodes, materials } = useGLTF('/new_tshirt10.glb')
  return (
    <group {...props} dispose={null}>
      ...
      <Decal  position={[x,0.2,z]} rotation={[-1.6,1,0]} scale={[1, 1, 1]} map={texture} />
      </mesh>
      ...
      <Decal  position={[-1,0.8,z]} rotation={[-1.6,1,0]} scale={[1, 1, 1]} map={texture} />
...
useGLTF.preload('/new_tshirt10.glb')
