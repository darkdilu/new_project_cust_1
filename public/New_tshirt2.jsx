...
Command: npx gltfjsx@6.4.1 new_tshirt2.glb 
*/
...
export default function Model(props) {
  ...
  const { nodes, materials } = useGLTF('/new_tshirt2.glb')
  return (
    <group {...props} dispose={null}  scale={[7, 7, 7]}>
      ...
      <Decal  position={[-0.3,0.1,-1.5]} rotation={[-1.7,-1,0]} scale={[2, 2, 2]} map={texture} />
...
useGLTF.preload('/new_tshirt2.glb')
