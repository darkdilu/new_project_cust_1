...
Command: npx gltfjsx@6.4.1 new_tshirt4.glb 
*/
...
export default function Model(props) {
  ...
  const { nodes, materials } = useGLTF('/new_tshirt4.glb')


  const { z } = useControls({
   
    z: { value: -1.7, min: -2.15, max: -1.4, step: 0.01 }
  })
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <Decal  position={[-1,0.2,z]} rotation={[-1.6,1,0]} scale={[1, 1, 1]} map={texture} />
...
useGLTF.preload('/new_tshirt4.glb')
